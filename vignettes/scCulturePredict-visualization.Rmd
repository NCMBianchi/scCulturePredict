...
# Visualizing SingleCellExperiment Results

The `scCulturePredict` package seamlessly handles visualization of results from SingleCellExperiment objects. The same visualization functions work regardless of the input data format.

## Visualizing SCE-based Analysis

```{r sce_visualization, eval=FALSE}
